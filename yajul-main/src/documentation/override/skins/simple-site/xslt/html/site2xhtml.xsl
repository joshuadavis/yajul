...
<head>
			...
			<meta name="author" value="Joshua Davis" />
			<meta name="email" value="pgmjsd@sourceforge.net" />
...
<body>
	...
	<!-- TODO: Move the src value into a 'gump' property in ./properties.xml
	(i.e. figure out how to encode the darn ampersand) -->
	<img id="jakartaLogo" src="@group-logo.src@" border="0"/>
	</a>
	</td>
	<td id="projectLogoTD" valign="middle" align="right">
	<a href="@project-logo.href@">
	<img id="projectLogo" src="@project-logo.src@" border="0"/>
	</a>
	</td>
	</tr>
			</table></div>
...
--> 
  ...
  <a href="http://sourceforge.net"><img src="http://sourceforge.net/sflogo.php?&amp;group_id=36516&amp;type=1" width="88" height="31" border="0" alt="SourceForge.net Logo"/></a>
		<!-- end footer -->
