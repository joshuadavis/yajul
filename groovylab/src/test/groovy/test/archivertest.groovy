...
archiver.source.executeUpdate('drop table if exists ' + tableName)
archiver.target.executeUpdate('drop table if exists ' + tableName)
archiver.source.executeUpdate('create table ' + tableName + ''' (
