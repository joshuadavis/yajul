...
/**
 * Provides a POSIX-like condition variable, for the purposes of synchronizing
 * threads.  This allows a more flexible relationship between mutex locks
 * and notification than the standard wait() and notify() methods
 * providied by Java.
 * <b>IMPORTANT NOTE:</b><br>
 * DO NOT USE THE wait() METHOD ON INSTANCES OF CondVar!!!!<br>
 * Use the cvWait(), or timedWait() methods!
 * <br>
 * Created Aug 28, 2002 1:14:40 PM
 * @author jdavis
 */
public class CondVar
{
     ...
     * </ol>
     * @param flag The flag that must be released before the signal, and
     * re-acquired after the signal.
     * @param millis The number of milliseconds to wait.  Waits forever if
     * this is zero.
    ...
    public void timedWait(BusyFlag flag, long millis) throws InterruptedException
    {
        ...
        if (syncFlag == null)
            throw new IllegalArgumentException(
                    "A synchronization flag is required!");
        // --- End of preconditions ---
    ...
    /**
     * Signals one and only one waiter.  The calling thread must have acquired
     * a lock on the flag before calling this.
