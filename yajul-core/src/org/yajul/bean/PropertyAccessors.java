...
public class PropertyAccessors
{
     ...
     * @throws java.lang.reflect.InvocationTargetException if the setter cannot be accessed
     ...
     * @throws java.lang.reflect.InvocationTargetException if the getter cannot be accessed
