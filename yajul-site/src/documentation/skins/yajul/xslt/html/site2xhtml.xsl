    ...
    <table border="0" width="100%" cellpadding="0" cellspacing="0" summary="footer">
      ...
      <tr>
        <td align="center" class="copyright" bgcolor="{$background-bars}" colspan="2">
          <font face="Tahoma, Arial, Helvetica, Sans-Serif" size="1">Copyright &#169;
      ...
      <tr>
        <td class="logos" bgcolor="{$background-bars}" align="center" colspan="2">
          ...
          </xsl:if> <!-- If filename is 'index.html' -->
          <!-- [jsd] Moved hosting logo into the previous div tag. -->
        </td>
      </tr>
    </table>
