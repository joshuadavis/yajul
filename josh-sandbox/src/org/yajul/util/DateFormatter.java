...
/**
 * Provides a thread safe wrapper for a DateFormat (date formats are not thread safe).  Synchronizes calls and delegates
 * them to an inner DateFormat object. 
 * (This is an old trick I learned when implementing XML-RPC and the XSL Servlet framework [jsd])
 * <br>... and YES, DateFormat is not thread safe (sez Sun)!<br>
 * The following is an example of a common exception thrown when DateFormat is used by multiple threads in JDK 1.3:
 * <pre>
