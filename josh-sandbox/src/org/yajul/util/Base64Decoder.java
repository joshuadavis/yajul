...
public class Base64Decoder
{
            ...
            throws Base64FormatException
    {
        ...
        {
            throw new Base64FormatException("Unexpected IOException: " + e.getMessage());
        }
        String s;
        try
        {
