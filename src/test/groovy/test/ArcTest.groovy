...
*/
    ...
    Date date = doArchiverTest(archiver)
...
// HSQLDB capitalizes table names
    ...
    // Create a table...
    println "creating ${sourceTableName}..."
    sourceSql.executeUpdate('drop table if exists ' + sourceTableName)
    targetSql.executeUpdate('drop table if exists ' + targetTableName)
    sourceSql.executeUpdate('create table ' + sourceTableName + ''' (
