...
/**
 * Implements the Relationship interface as a TreeSet.
 * <br><br>
 * 
 * This implementation should perform nearly as fast as MapRelationship, and
 * use memory more efficiently.  Specifically:<br><br>
 * 
 * <code><b>SetRelationship</b></code>: Lookups are <b>O(log(N))</b>.  The structure consists of exactly 1 Set.<br>
 * {@link MapRelationship MapRelationship}: Lookups are <b>O(1)</b>.  The structure uses <b>N+M</b> Sets, where <b>N</b> is the number of determinants, and <b>M</b> is the
 ...
 * 
 */
public class SetRelationship extends TreeSet implements Relationship {
	...
	protected static class Entry implements Comparable {
		...
		protected Object m_determinant;
		/** The object which is determined.  (B in A->B) */
		protected Object m_dependent;
	 ...
	 */
	abstract class TransformingSet extends AbstractSet {
		...
		public Iterator iterator() {
			...
			return new Iterator() {
				...
				private Iterator m_it = m_set.iterator();
				
				public Object next() {
					m_current = transform(m_it.next());
					return m_current;
				}
