...
public class ReflectionUtilTest extends TestCase {
    ...
    public void testConstantMap() throws Exception {
        ...
        // Test with JTA Status interface
        map = ReflectionUtil.getConstantNameMap(Status.class);
        assertEquals("STATUS_ACTIVE", map.get(Status.STATUS_ACTIVE));
        assertEquals("STATUS_ROLLEDBACK", map.get(Status.STATUS_ROLLEDBACK));
    }
